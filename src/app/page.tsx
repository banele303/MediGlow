                  ...
                  >
                    <Link href="/services">
                      <motion.div className="relative group inline-block" whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}>
                        <Button size="lg" className="relative overflow-hidden bg-emerald-500 hover:bg-emerald-600 text-white text-base px-2 md:px-7 py-6 rounded-full shadow-xl">
                          {/* Animated shine */}
                          <motion.div
                    ...
                    <Link href="#contact">
                      <Button variant="outline" size="lg" className="border-emerald-300 text-emerald-700 hover:bg-emerald-50 text-base px-2 md:px-7 py-6 rounded-full">
                        Book a Consultation
                      </Button>
                    </Link>
                  </motion.div>
