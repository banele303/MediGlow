...
export default function ProductsPage() {
  ...
  return (
    <div className="pt-20 overflow-hidden">
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              >
                <Button 
                  size="lg" 
                  className="bg-gradient-to-r from-emerald-500 to-teal-600 hover:from-emerald-600 hover:to-teal-700 text-white px-8 py-6 rounded-2xl shadow-2xl hover:shadow-emerald-500/25 transition-all duration-300 group text-lg"
                >
            ...
            {categories.map((category, index) => (
              ...
              >
                <Button
                  ...
                  className={`px-6 py-3 rounded-2xl font-medium transition-all duration-300 group ${
                ...
                <Card className="h-full bg-white/90 backdrop-blur-sm border-0 shadow-lg hover:shadow-2xl transition-all duration-500 overflow-hidden group-hover:scale-[1.02] group-hover:-translate-y-2">
                  <CardContent className="p-0">
                    ...
                    <div className="relative h-64 overflow-hidden">
                      <Image
                        src={
                          product.category === 'cleansers' ? '/algae.jpg' :
                          product.category === 'serums' ? '/algae2.jpg' :
                          product.category === 'moisturizers' ? '/algae3.jpg' :
                          product.category === 'suncare' ? '/alagepels2.jpg' :
                          product.category === 'treatments' ? '/algae-peel.jpg' :
                          '/algae.jpg'
                        }
                        alt={product.name}
                        width={400}
                      ...
                      <motion.div
                        className="absolute top-3 left-3 bg-white/90 backdrop-blur-sm px-3 py-1 rounded-full text-xs font-semibold text-emerald-700 shadow-lg"
                        initial={{ opacity: 0, scale: 0.8 }}
                      ...
                      <motion.div
                        className="absolute bottom-3 left-3 bg-black/70 backdrop-blur-sm px-2 py-1 rounded-lg text-white text-xs font-medium opacity-0 group-hover:opacity-100 transition-opacity duration-300"
                        whileHover={{ scale: 1.05 }}
                      >
                    ...
                    {/* keep overlays within the relative container */}
                      ...
                      <div className="absolute top-4 left-4 space-y-2">
                        {product.bestseller && (
                          <span className="inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold bg-emerald-500 text-white">
      ...
      <section className="py-20 bg-gradient-to-br from-gray-900 via-emerald-900 to-teal-900 text-white relative overflow-hidden">
        {/* Background Effects */}
        <div className="absolute inset-0">
          {[...Array(10)].map((_, i) => (
            <motion.div
              key={i}
              className="absolute rounded-full bg-gradient-to-r from-emerald-400/20 to-teal-400/20 blur-xl"
              style={{
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4">
          ...
          >
            <motion.div
              className="inline-flex items-center px-6 py-3 rounded-full bg-gradient-to-r from-emerald-500/20 to-teal-500/20 border border-emerald-400/30 mb-6"
              whileHover={{ scale: 1.05 }}
            >
              <TrendingUp className="w-5 h-5 mr-2 text-emerald-400" />
              <span className="text-emerald-300 font-semibold">Why Choose Our Products?</span>
            </motion.div>
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
              Experience the difference with our scientifically-formulated products designed for maximum efficacy and results.
            </p>
          </motion.div>
            ...
            {[
              {
                ...
                description: "All products undergo rigorous clinical testing for safety and efficacy",
                color: "from-blue-400 to-cyan-400"
              },
              {
                icon: Leaf,
                title: "Natural Ingredients",
                description: "Premium botanical extracts sourced sustainably from around the world",
                color: "from-green-400 to-emerald-400"
              },
              {
                icon: Zap,
                title: "Fast Results",
                description: "See visible improvements in your skin within 7-14 days of use",
              ...
              <motion.div
                ...
                className="group"
              >
                <div className="bg-white/10 backdrop-blur-md border border-white/20 rounded-3xl p-8 h-full hover:bg-white/15 transition-all duration-500 relative overflow-hidden">
                  {/* Hover Glow Effect */}
                  ...
                  <motion.div
                    className={`w-16 h-16 mx-auto mb-6 rounded-2xl bg-gradient-to-br ${feature.color} flex items-center justify-center relative`}
                    whileHover={{ rotate: 360 }}
                    transition={{ duration: 0.8 }}
                  >
                  ...
                  <h3 className="text-xl font-bold text-white mb-4 text-center group-hover:text-emerald-300 transition-colors">
                    {feature.title}
                  </h3>
                  
                  <p className="text-gray-300 leading-relaxed text-center group-hover:text-white transition-colors">
                    {feature.description}
                  </p>
                </div>
              </motion.div>
          ...
          >
            <Button 
              size="lg" 
              className="bg-gradient-to-r from-emerald-500 to-teal-600 hover:from-emerald-600 hover:to-teal-700 text-white px-12 py-6 rounded-2xl shadow-2xl hover:shadow-emerald-500/25 transition-all duration-300 group text-lg font-semibold"
            >
      ...
      <section className="section-padding skincare-gradient">
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Our products feature the most effective skincare ingredients backed by science.
            </p>
          </motion.div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              },
              {
                ...
                description: "Holds 1000x its weight in water for intense hydration"
              },
              {
                icon: Moon,
                name: "Retinol",
                description: "Gold standard for anti-aging and skin renewal"
              },
              {
                icon: Zap,
                name: "Niacinamide",
                ...
                <Card className="h-full bg-white/80 backdrop-blur-sm border-0 shadow-lg hover:shadow-xl transition-all duration-300">
                  <CardContent className="p-8 text-center space-y-6">
                    <motion.div
                      ...
                      transition={{ duration: 0.8 }}
                    >
                      <ingredient.icon className="w-full h-full text-emerald-500" />
